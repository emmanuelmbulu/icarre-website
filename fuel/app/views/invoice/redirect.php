            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <input type="hidden" name="reference_number" value="<?= $transaction->reference ?>" >
                        <input type="hidden" name="auth_trans_ref_no" value="">
                        <input type="hidden" name="amount" value="<?= $transaction->amount ?>">
                        <input type="hidden" name="currency" value="<?= $transaction->currency ?>">
                        <input type="hidden" name="locale" value="<?= $lang == 'en' ? 'en-us' : 'fr-fr' ?>" >
                        <input type="hidden" name="override_custom_receipt_page" value="<?= Router::get("callback-invoice", ["lang" => $lang, "ref" => $transaction->id]) ?>">
                        <input type="hidden" name="device_fingerprint_id" value="<?= $sessionId ?>" />
                        <input type="hidden" name="merchant_descriptor" value="iCarré">
                        <input type="hidden" name="customer_ip_address" value="<?= $transaction->ip_address ?>">
