...
$routeReceipt = Helper::NormalizeChars($payment->reference);
$routeReceipt = strtolower($routeReceipt);
$routeReceipt = Router::get("receipt-pdf", ["ref"=>$routeReceipt]);
?>
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="alert alert-success" role="alert" style="text-align: center">
                    ...
                    <br><br>
                    <h4 class="alert-heading"><?= Lang::get("approved.title", [], null, $lang) ?></h4>
                    <hr>
                    <p class="mb-0">
                        <?= Lang::get("approved.message", [], null, $lang) ?>
                        <br>
                        <a href="<?= $routeReceipt ?>"><?= Lang::get("approved.link", [], null, $lang) ?></a>
                    </p>
                </div>
